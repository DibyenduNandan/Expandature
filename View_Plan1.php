...
if (isset($_POST['submit']))
{
    ...
    if($numExistRows2==1)
    {
        ...
        $css_class="danger";
        header("location:View_Plan.php?bud=".$bud."&Dat=".$Dat."&no=".$no."&Dat2=".$Dat2."&dat=".$dat."&ord=".$ord."&arr=".urlencode($_POST['arr'])."&sno=".$sno."&".http_build_query(arr($_POST['arr']))."&msg=".$msg."&css_class=".$css_class."");
    }
    else
    {
